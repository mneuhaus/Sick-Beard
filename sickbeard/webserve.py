...
class NewHomeAddShows:
    ...
    def addNewShow(self, whichSeries=None, tvdbLang="en", rootDir=None, defaultStatus=None,
                   ...
                   other_shows=None, skipShow=None, audioLangs=None):
        """
        ...
        # add the show
        sickbeard.showQueueScheduler.action.addShow(tvdb_id, show_dir, int(defaultStatus), newQuality, flatten_folders, tvdbLang, audioLangs) #@UndefinedVariable
