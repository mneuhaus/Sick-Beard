...
class ShowQueue(generic_queue.GenericQueue):
    ...
    def addShow(self, tvdb_id, showDir, default_status=None, quality=None, season_folders=None, lang="en", audio_lang="en"):
        queueItemObj = QueueItemAdd(tvdb_id, showDir, default_status, quality, season_folders, lang, audio_lang)
...
class QueueItemAdd(ShowQueueItem):
    def __init__(self, tvdb_id, showDir, default_status, quality, season_folders, lang, audio_lang):
